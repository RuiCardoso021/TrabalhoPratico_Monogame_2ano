...
namespace TrabalhoPratico_Monogame_2ano
{
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            _tank = new ClsTank(_graphics.GraphicsDevice, Content.Load<Model>("tank"), new Vector3(50f, 0f, 40f), false, new Keys[] { Keys.A, Keys.W, Keys.D, Keys.S, Keys.Q, Keys.E, Keys.F, Keys.H, Keys.T, Keys.G, Keys.LeftShift, Keys.Space });
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            _tank.Update(gameTime, _terrain, this, _tankEnemy);
            _tankEnemy.Update(gameTime, _terrain, this, _tank);
